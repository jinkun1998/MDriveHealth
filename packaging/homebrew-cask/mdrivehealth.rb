...
# Submit to a tap (e.g. maclifevn/homebrew-tap) once a public GitHub
# release exists:  brew tap maclifevn/tap && brew install --cask mdrivehealth
...
cask "mdrivehealth" do
  ...
  url "https://github.com/maclifevn/MDriveHealth/releases/download/v#{version}/MDriveHealth-#{version}.dmg"
  name "MDriveHealth"
  desc "Drive & system health monitor with SMART, benchmark, and fake-capacity check"
  homepage "https://github.com/maclifevn/MDriveHealth"
